              ...
              >
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src={Pic1} className="d-block w-100 carr" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={Pic2} className="d-block w-100 carr" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={Pic3} className="d-block w-100 carr" alt="..." />
                  </div>
                  <div className="carousel-item">
                    <img src={Pic4} className="d-block w-100 carr" alt="..." />
                  </div>
                </div>
                <a
              ...
              <div className="row col-md-12 icons-div">
                <div className="col-md-3">
                  <div className="icon-text">
                    <p>Time off for Pleasure?</p>
                  </div>
                  <div>
                    <img alt="fun-icon" className={Styles["icons"]} src={Fun} />
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="icon-text">
                    <p>Need to fix your Health?</p>
                  </div>
                  <div>
                    <img
                      alt="health-icon"
